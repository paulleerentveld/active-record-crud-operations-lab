...
def can_be_found_updated_and_saved
  ...
  updated = Movie.find_by(title: "Awesome Flick")
  updated.title = "Even Awesomer Flick"
  updated.save
end
...
def can_update_using_update_method
  ...
  updated = Movie.find_by(title: "Wat?")
  updated.title = "Wat, huh?"
  updated.save
end
...
def can_destroy_a_single_item
  ...
  delete = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  delete.destroy
end
